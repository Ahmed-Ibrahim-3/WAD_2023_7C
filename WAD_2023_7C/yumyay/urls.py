...
urlpatterns = [
    ...
    path('cooking/<slug:cuisine_name_slug>/<slug:recipe_name_slug>/', views.recipe, name='recipe'),
    path('baking/<slug:cuisine_name_slug>/<slug:recipe_name_slug>/', views.recipe, name='recipe'),
